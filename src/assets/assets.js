...
export const testimonials = [
    {
      quote:
        'I\'ve been using Learnify for nearly two years, primarily for Instagram, and it has been incredibly user-friendly, making my work much easier.',
      name: "Sarah Chen",
    ...
    {
      quote:
        "Learnify has been my go-to tool for over a year now—especially for Instagram—and its simplicity has saved me so much time and effort.",
    ...
    {
      quote:
        "Learnify’s user-friendly design is what keeps me coming back. It’s been a reliable companion in my Instagram journey for nearly two years.",
      name: "Emily Watson",
