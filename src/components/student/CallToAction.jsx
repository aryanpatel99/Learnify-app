...
const CallToAction = () => {
  ...
  Start learning at your own pace — from anywhere, at any time.</p>
      <div className='flex items-center gap-6 font-medium mt-4'>
        <button className='px-8 py-2 rounded-lg text-white text-sm bg-blue-600 hover:bg-blue-700'>Get Started</button>
        <button className='flex items-center gap-2 px-8 py-2 text-sm rounded-lg border border-gray-500 hover:bg-gray-100'>Learn More <img src={assets.arrow_icon} alt='arrow icon'/></button>
