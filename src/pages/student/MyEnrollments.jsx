            ...
            <tr key={index} className='border border-gray-500/20'>
              <td className='md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3'>
                ...
                <div className='flex-1'>
                  ...
                  {/* for progress line */}
                  <Line strokeWidth={2} percent={progressArray[index] ? (progressArray[index].lectureCompleted * 100 )/progressArray[index].totalLectures: 0} strokeColor="#3B82F6" className='bg-gray-300 rounded-full'/>
                </div>
              </td>
